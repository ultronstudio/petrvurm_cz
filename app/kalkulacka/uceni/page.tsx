    ...
    return (
      <Card
        ...
        className={`relative p-6 rounded-2xl border border-white/10 bg-white/5 backdrop-blur transition
          ${active ? "ring-2 ring-primary scale-[1.02]" : "hover:border-white/20"}`}
          ...
          {!selectedItem ? (
            ...
            <>
              ...
              <a
                ...
                className="mt-4 inline-flex w-full items-center justify-center rounded-md bg-primary px-4 py-2 text-sm font-semibold text-black transition hover:bg-primary/90"
              >
          ...
          <div className="min-w-[200px]">
            {selectedItem && (
              <>
                ...
                <a
                  href={generateMailtoLink()}
                  className="mt-2 inline-flex w-full items-center justify-center rounded-md bg-primary px-4 py-2 text-sm font-semibold text-black transition hover:bg-primary/90"
                >
                  Nezávazně kontaktovat
                </a>
              </>
