    ...
    <section className="py-20">
      <div className="container mx-auto max-w-4xl px-4 text-[17px] leading-relaxed md:px-6">
        ...
        <div className="space-y-10 text-white/90">
          <section className="space-y-3"><h2 className="text-2xl font-semibold text-primary">1. Správce osobních údajů</h2><p>Správcem osobních údajů je <strong>Petr Vurm</strong>, IČ: 21180164, se sídlem Tůně 6, 503 15 Nechanice, Česká republika.<br />Kontakt: <a href="mailto:kontakt@petrvurm.cz" className="text-primary hover:underline">kontakt@petrvurm.cz</a>.</p></section>
