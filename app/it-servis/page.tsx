    ...
    <section className="py-14 md:py-18">
      <div className="container mx-auto max-w-4xl px-4 md:px-6">
        ...
        <section className="mt-10 border-t border-white/10 pt-7" aria-labelledby="obsluhovane-lokality">
          ...
          <p className="mt-3 max-w-2xl text-sm leading-6 text-white/65">Samostatné stránky mám jen pro oblasti, které běžně obsluhuji. U jiné obce se můžeme domluvit individuálně.</p>
        ...
        <section className="mt-10 border-t border-white/10 pt-7">
          ...
          <p className="mt-3 max-w-xl text-white/65">Napište mi, co potřebujete vyřešit a kde.</p>
