...
export default function Kontakt() {
  const [randomAd, setRandomAd] = useState({ title: '', url: '' });
  ...
  const reklamy = [
    ...
    {
      title: "WEDOS Global",
      url: "https://www.wedos.com/cs/global/?ap=Er80JB",
    },
    { title: "WEDOS NIS2", url: "https://wedos.global/cs/nis2/?ap=Er80JB" },
    {
      title: "WEDOS webhosting",
      url: "https://www.wedos.com/cs/webhosting/?ap=Er80JB",
    },
    {
      title: "WEDOS Webhosting Managed Server (WMS)",
      url: "https://www.wedos.com/cs/wms/?ap=Er80JB",
    },
    {
      title: "WEDOS WebSite",
      url: "https://www.wedos.com/cs/website/?ap=Er80JB",
    },
    {
      title: "WEDOS mailhosting",
      url: "https://www.wedos.com/cs/mailhosting/?ap=Er80JB",
    },
    {
      title: "WEDOS domény",
      url: "https://www.wedos.com/cs/domeny/?ap=Er80JB",
    },
    { title: "WEDOS Cloud", url: "https://www.wedos.com/cs/cloud/?ap=Er80JB" },
    {
      title: "WEDOS virtuální servery",
      url: "https://www.wedos.com/cs/vps-on/?ap=Er80JB",
    },
    {
      title: "WEDOS dedikované servery",
      url: "https://www.wedos.com/cs/dedikovane-servery/?ap=Er80JB",
    },
    {
      title: "WEDOS Cloud Disk (CD)",
      url: "https://www.wedos.com/cs/cd/?ap=Er80JB",
    },
    {
      title: "WEDOS Disk",
      url: "https://www.wedos.com/cs/wedos-disk/?ap=Er80JB",
    },
  ];

  useEffect(() => {
    // Náhodný výběr reklamy
    const randomIndex = Math.floor(Math.random() * reklamy.length);
    setRandomAd(reklamy[randomIndex]);
  }, []); // Prázdné závislosti = provede se jen jednou po mountnutí komponenty

  if (!randomAd) {
    return <div>Načítám reklamu...</div>; // Nebo zobrazit nějaký placeholder
  }
...
>>>>>>> f467fdce03adb9e34eae2cc8a6eaccdbcf8d5828
          ...
          <Card className="w-full p-4 rounded-lg ml-4">
            ...
            <p className="mt-2">
              <a href="tel:+420777416611" className="link">
                +420 777 416 611
              </a>
            </p>
          </Card>
              ...
              <div className="w-full p-2">
                <p className="mt-2 text-lg">
                  {randomAd.title != "WEDOS"
                    ? `${randomAd.title} se slevou! Klikněte zde pro více informací.`
                    : "WEDOS - webhosting, domény a servery slevou! Klikněte zde pro více informací."}
                </p>
              </div>
            </Link>
          </Card>
